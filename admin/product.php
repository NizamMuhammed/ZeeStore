...
<body style="margin-top: -30px">
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // input data to db
    $sql = "INSERT INTO `products`(`product_id`,`product_name`, `brand_id`, `category_id`, `description`, `price`, `quantity`, `image`, `image_type`) 
            VALUES (NULL,'" . $_POST['product_name'] . "','" . $_POST['brand_id'] . "','" . $_POST['category_id'] . "','" . $_POST['description'] . "','" . $_POST['price'] . "','" . $_POST['quantity'] . "','$image_data','$iimage_type')";
